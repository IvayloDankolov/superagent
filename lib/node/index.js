...
/**
 * Enable progress tracking uploads.
 * 
 * @param {Function} callback If supplied, it is automatically set as a progress event handler.
 * @return {Request} for chaining
 * @api public
 */

Request.prototype.monitorUpload = function(callback) {
  this._monitorUpload = true;
...
Request.prototype.end = function(fn){
  ...
  } else if(this._monitorUpload) {

    (new utils.BufferStream(data)).pipe(getProgressMonitor()).pipe(req);
  } else {
    req.end(data);
  }
